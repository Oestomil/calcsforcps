    ...
    <div style={outerStyle}>
      <div style={mainCard}>
        <div style={topBar}>
          ...
          <span style={headerText}>{t('Titan/Baryum Hesaplama')}</span>
        </div>
...
const calcBtn = {
  ...
  fontWeight: 700,
  color: "#f9faff",
  background: "linear-gradient(90deg,#5ee061 20%,#0ecbc6 100%)",
  boxShadow: "0 1px 8px #0ecbc622",
  letterSpacing: "0.01em",
